package io.wurmatron.plants.common.research;
...
public class ResearchHelper {
	...
	public static void registerResearch () {
		PlantsEvolvedAPI.register (land);
		PlantsEvolvedAPI.register (greenHouse);
		PlantsEvolvedAPI.register (underGround);
		PlantsEvolvedAPI.register (hydroPonics);
		PlantsEvolvedAPI.register (synthesis);
		PlantsEvolvedAPI.register (augmentation);
		PlantsEvolvedAPI.register (basic);
		PlantsEvolvedAPI.register (quarry);
		PlantsEvolvedAPI.register (sifting);
		PlantsEvolvedAPI.register (deep);
		PlantsEvolvedAPI.register (deepCore);
		PlantsEvolvedAPI.register (deepSea);
		PlantsEvolvedAPI.register (astro);
		PlantsEvolvedAPI.register (extraDimensional);
		PlantsEvolvedAPI.register (synchysisMine);
		PlantsEvolvedAPI.register (fuel);
		PlantsEvolvedAPI.register (nuclear);
		PlantsEvolvedAPI.register (fusion);
		PlantsEvolvedAPI.register (solar);
		PlantsEvolvedAPI.register (wind);
		PlantsEvolvedAPI.register (hydro);
		PlantsEvolvedAPI.register (extraDimensionalEnergy);
		PlantsEvolvedAPI.register (star);
		PlantsEvolvedAPI.register (interstellar);
		PlantsEvolvedAPI.register (primative);
		PlantsEvolvedAPI.register (steam);
		PlantsEvolvedAPI.register (mass);
		PlantsEvolvedAPI.register (robotic);
		PlantsEvolvedAPI.register (atomicAssembly);
		PlantsEvolvedAPI.register (written);
		PlantsEvolvedAPI.register (computational);
		PlantsEvolvedAPI.register (ai);
	}
